...
/**
* @see \App\Http\Controllers\MoveController::move
* @see app/Http/Controllers/MoveController.php:15
* @route '/game/{playerToken}/moves'
*/
export const move = (args: { playerToken: string | number } | [playerToken: string | number ] | string | number, options?: RouteQueryOptions): RouteDefinition<'post'> => ({
...
* @route '/game/{playerToken}/moves'
*/
move.url = (args: { playerToken: string | number } | [playerToken: string | number ] | string | number, options?: RouteQueryOptions) => {
    if (typeof args === 'string' || typeof args === 'number') {
        args = { playerToken: args }
    }
...
* @route '/game/{playerToken}/moves'
*/
move.post = (args: { playerToken: string | number } | [playerToken: string | number ] | string | number, options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: move.url(args, options),
    method: 'post',
})
...
* @route '/game/{playerToken}/moves'
*/
const moveForm = (args: { playerToken: string | number } | [playerToken: string | number ] | string | number, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
...
* @route '/game/{playerToken}/moves'
*/
moveForm.post = (args: { playerToken: string | number } | [playerToken: string | number ] | string | number, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
    action: move.url(args, options),
    method: 'post',
})
